...
STREAM_SG_PCM_ADD(`audioreach/subgraph-stream-vol-playback.m4', 1,
	`S16_LE', 48000, 48000, 2, 2,
	0x00004002, 0x00004002, 0x00006010, `110000')

STREAM_SG_PCM_ADD(`audioreach/subgraph-stream-capture.m4', 2,
	`S16_LE', 48000, 48000, 1, 2,
	0x00004003, 0x00004003, 0x00006020, `110000')

STREAM_SG_PCM_ADD(`audioreach/subgraph-stream-capture.m4', 3,
	`S16_LE', 48000, 48000, 1, 2,
...
dnl ---------------------------------------------------------------------
dnl RX_CODEC_DMA_RX_0 device (playback backend)
dnl ---------------------------------------------------------------------

DEVICE_SG_ADD(`audioreach/subgraph-device-codec-dma-playback.m4',
	`RX_CODEC_DMA_RX_0', 113,
	`S16_LE', 48000, 48000, 1, 2,
...
STREAM_DEVICE_PLAYBACK_MIXER(40, ``SECONDARY_TDM_RX_0'', ``MultiMedia1'', ``MultiMedia2'')
STREAM_DEVICE_PLAYBACK_MIXER(113, ``RX_CODEC_DMA_RX_0'', ``MultiMedia1'', ``MultiMedia2'')

STREAM_DEVICE_PLAYBACK_ROUTE(40, ``SECONDARY_TDM_RX_0 Audio Mixer'', ``MultiMedia1, stream0.logger1'', ``MultiMedia2, stream1.logger1'')
STREAM_DEVICE_PLAYBACK_ROUTE(113, ``RX_CODEC_DMA_RX_0 Audio Mixer'', ``MultiMedia1, stream0.logger1'', ``MultiMedia2, stream1.logger1'')

STREAM_DEVICE_CAPTURE_MIXER(2, ``VA_CODEC_DMA_TX_0'')
STREAM_DEVICE_CAPTURE_MIXER(3, ``VA_CODEC_DMA_TX_0'')

STREAM_DEVICE_CAPTURE_ROUTE(2, ``MultiMedia3 Mixer'', ``VA_CODEC_DMA_TX_0, device110.logger1'')
STREAM_DEVICE_CAPTURE_ROUTE(3, ``MultiMedia4 Mixer'', ``VA_CODEC_DMA_TX_0, device110.logger1'')
