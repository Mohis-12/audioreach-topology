...
STREAM_DEVICE_PLAYBACK_MIXER(AIF_TDM_RX_2, ``AIF_TDM_RX_2'', ``MultiMedia1'')
STREAM_DEVICE_PLAYBACK_MIXER(RX_CODEC_DMA_RX_1, ``RX_CODEC_DMA_RX_1'', ``MultiMedia3'')

STREAM_DEVICE_PLAYBACK_ROUTE(AIF_TDM_RX_2, ``AIF_TDM_RX_2 Audio Mixer'', ``MultiMedia1, stream0.logger1'')
